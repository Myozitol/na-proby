...
// Аккордионы
    ...
    accordionLists.forEach( el => {
        el.addEventListener('click', e => {
            ...
            const activeAccordion = document.querySelector('.accordion-list__item--opened')
            const activeContent = document.querySelector('.accordion-list__item--opened .accordion-list__content')
